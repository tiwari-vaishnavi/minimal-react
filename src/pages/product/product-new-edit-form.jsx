...
import { PRODUCT_CATEGORY_GROUP_OPTIONS, PRODUCT_COLOR_NAME_OPTIONS, PRODUCT_GENDER_OPTIONS, PRODUCT_SIZE_OPTIONS, _tags } from '../../_mock';
      ...
      <Grid xs={12} md={8}>
        <Card>
          ...
          <Stack spacing={3} sx={{ p: 3 }}>
            ...
            <FormControlLabel
              control={<Switch checked={includeTaxes}/>}
